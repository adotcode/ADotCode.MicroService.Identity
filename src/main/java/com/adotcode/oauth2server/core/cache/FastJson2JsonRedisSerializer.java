package com.adotcode.oauth2server.core.cache;

import com.adotcode.oauth2server.core.constant.ApplicationConstants;
...
public class FastJson2JsonRedisSerializer<T> implements RedisSerializer<T> {
  ...
  static {
    ...
    //ParserConfig.getGlobalInstance().addAccept("com.adotcode.oauth2server.");
  }
